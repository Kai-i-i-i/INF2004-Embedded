...
int main() {
    stdio_init_all();
        ...
        #warning i2c/transmitter example requires a board with I2C pins
        ...
        while (1) {
            ...
            uint8_t tx_data[] = "Hello, Receiver!";

            printf("Sending message: %s\n", tx_data);

            i2c_write_blocking(i2c_default, i2c_address, tx_data, sizeof(tx_data) - 1, false);  // -1 to exclude null terminator
