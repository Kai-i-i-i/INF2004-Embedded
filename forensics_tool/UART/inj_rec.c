...
// // Declare default string to be sent.
// char *injectString = "Hello from Pico!\n";
...
//     // When GP15 is high, send the string 'Hello from Pico!' through UART0.
//     uart_puts(UART_ID, injectString);
//     sleep_ms(900);  // Add a small delay after sending the string for
//     consistency
//    }
// //   else {
// //     // When GP15 is low, enter sniffing mode.
...
// //         // Check if the received string index reaches the maximum length
// //         if (receivedStringIndex >= MAX_STRING_LENGTH) {
// //           // If the maximum length is reached, reset the received string
// index
// //           // and received string
// //           receivedStringIndex = 0;
// //           memset(receivedString, 0, sizeof(receivedString));
...
//     }
//     // else {
//     //   // Do nothing for loopback scenario
//     // }
//   }
// }
...
//   while (true) {
//     send_data();  // Call the function to send data based on GP15's state
//     receive_and_process();  // Call the function to receive and process data
//     for
//                             // loopback
//     sleep_ms(100);          // Small delay between send/receive cycles
//   }
